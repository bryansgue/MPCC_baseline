"""
T_UAV_baseline.py  –  NMPC baseline for quadrotor trajectory tracking.
...
x_real  = 3.0;  y_real  = 3.0;  z_real  = 2.0
vx_real = 0.0;  vy_real = 0.0;  vz_real = 0.0
qw_real = 1.0;  qx_real = 0.0;  qy_real = 0.0;  qz_real = 0.0
wx_real = 0.0;  wy_real = 0.0;  wz_real = 0.0
...
# ═══════════════════════════════════════════════════════════════════════════════
#  Helper functions (I/O, odometry, etc.)
# ═══════════════════════════════════════════════════════════════════════════════

def get_odometry_complete():
    """Return full 13-state vector from global odometry variables."""
    global x_real, y_real, z_real, vx_real, vy_real, vz_real
    global qw_real, qx_real, qy_real, qz_real, wx_real, wy_real, wz_real
    return [
        x_real, y_real, z_real,
        vx_real, vy_real, vz_real,
        qw_real, qx_real, qy_real, qz_real,
